...
public class MainActivity<cal_EMI> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        principle =(EditText) findViewById(R.id.principleIn);
        rate =(EditText) findViewById(R.id.rateIn);
        month=(EditText) findViewById(R.id.monthIn);
...
//
            ...
            String EMILabel = " Calculated EMI is Rs: : " + roundTwoDecimals(EMI);
